...
class ContourWithData ():
    ...
    def checkIfContourIsValid(self):  # this is oversimplified, for a production grade program
        if self.aspectratio > 1:
            return False
        elif self.fltArea < MIN_CONTOUR_AREA:
...
def main():
    ...
    path = "C:/Users/lucky/Desktop/SSSS/"
    preprocess ( path, "13.jpg" )

#    imgTestingNumbers = cv2.imread(path + "preprocessed.jpg")

    imgTestingNumbers = cv2.resize ( cv2.imread ( path + "preprocessed.jpg" ), (350, 100),cv2.INTER_AREA )  # read in testing numbers image
